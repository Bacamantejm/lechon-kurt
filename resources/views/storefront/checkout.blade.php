        ...
        <div class="checkout-grid">
            ...
            <div class="checkout-summary">
                ...
                <div class="summary-totals">
                    <div class="total-row">
                        <span>Subtotal</span>
                        <span id="summarySubtotal">â‚±<?php echo number_format($subtotal, 2); ?></span>
                    </div>
                    <div class="total-row">
                        <span>Delivery Fee</span>
                        <span id="summaryDeliveryFee">â‚±<?php echo number_format($delivery_fee, 2); ?></span>
                    </div>
                    <div class="total-row">
                        <span>VAT (12%)</span>
                        <span id="summaryVat">â‚±<?php echo number_format($vat_amount, 2); ?></span>
                    </div>
                    <div class="total-row voucher-row" id="voucherSummaryRow" style="<?php echo $voucher_discount > 0 ? '' : 'display:none;'; ?>">
                        ...
                        <span id="summaryVoucherDiscount">- â‚±<?php echo number_format($voucher_discount, 2); ?></span>
                    </div>
                    <div class="total-row grand-total">
                        <span>Total Amount</span>
                        <span id="summaryTotal">â‚±<?php echo number_format($total, 2); ?></span>
                    </div>
                    ...
                    <div class="payment-breakdown" style="background: #fffdfb; border: 1px solid #efddcd; border-radius: 14px; padding: 16px; margin-top: 18px;">
                        ...
                        <div class="breakdown-row d-flex justify-content-between align-items-center mb-2" style="font-size: 0.88rem;">
                            ...
                            <strong class="downpayment-amount" style="color: #ef6b2e; font-size: 1rem; font-weight: 800;">â‚±<?php echo number_format($downpayment, 2); ?></strong>
                        </div>
                        <div class="breakdown-row d-flex justify-content-between align-items-center mb-2" style="font-size: 0.88rem;">
                            <span style="color: #667085; font-weight: 600;">Remaining Balance (70%):</span>
                            <span class="remaining-amount" style="color: #2a211d; font-weight: 700;">â‚±<?php echo number_format($remaining, 2); ?></span>
                        </div>
                        <div class="breakdown-row d-flex justify-content-between align-items-center pt-2" style="font-size: 0.88rem; border-top: 1px dashed #efddcd;">
                            ...
                            <span class="full-amount" style="color: #b3261e; font-weight: 800;">â‚±<?php echo number_format($total, 2); ?></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="checkout-form">
                ...
                <div class="progress-container" style="width: 100%; height: 6px; background: #efddcd; border-radius: 3px; margin-top: 15px; margin-bottom: 24px; overflow: visible; position: relative;">
                    <div class="progress-bar" id="checkoutProgressBar" style="position: absolute; left: 0; top: 0; height: 100%; width: 33.33%; background: #b3261e; transition: width 0.3s ease; display: block !important; overflow: visible;">
                        <div class="running-pig" style="position: absolute; right: -14px; top: -20px; font-size: 22px; user-select: none; line-height: 1; animation: pigRun 0.4s infinite alternate ease-in-out;">ðŸ–</div>
                    </div>
                </div>
        ...
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 14px;">
            <div>
                <h3 style="font-size: 20px; font-weight: 800; color: #2a211d; margin: 0; display: flex; align-items: center; gap: 8px;">
                    <i class="fas fa-location-dot" style="color: #b3261e;"></i> Whatâ€™s your exact location?
                </h3>
    ...
    if (submitExactBtn) {
        submitExactBtn.addEventListener('click', async function() {
            ...
            if (queryText) {
                ...
                const cityPart = parts.slice(1).join(',').trim() || 'DasmariÃ±as';
